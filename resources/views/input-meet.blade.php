                ...
                <div class="container mb-5">
                    <div class="card">
                        <div class="card-header text-center font-weight-bold">
                            Input Data Fans Meet n Greet
                        </div>
                        <div class="card-body">
                            <form name="add-blog-post-form" id="add-blog-post-form" method="post" action="{{url('kirim-meet')}}">
                            @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="interaksi" class="form-control @error('interaksi') is-invalid @enderror" >{{ old('interaksi') }}>
                                ...
                                <div class="form-group">
                                    ...
                                    <select type="text" id="sesi" name="sesi" class="form-control @error('sesi') is-invalid @enderror"  value="{{ old('sesi') }}">
